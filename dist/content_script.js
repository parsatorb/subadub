...
(function initializeSubadub() {
  ...
  function renderAndReconcile() {
    ...
    function addTrackElem(videoElem, blob, srclang) {
      ...
      customSubsElem.style.cssText = 'position: absolute; top: 10vh; left: 0; right: 0; color: yellow; font-size: 3vw; text-align: center; user-select: text; -moz-user-select: text; z-index: 100; pointer-events: none';
      ...
      trackElem.addEventListener('cuechange', function(e) {
        ...
        for (const cue of track.activeCues) {
          ...
          cueElem.style.cssText = 'background: rgba(0,0,0,0); white-space: pre-wrap; padding: 0.2em 0.3em; margin: 10px auto; width: fit-content; width: -moz-fit-content; pointer-events: auto';
